...
const FileInputComponent = ({
  ...
  thumbSize = "w-[96px] h-[96px]",
  thumbNail = null,
  imagePlaceholderSrc = "https://placehold.co/96x96?text=No Image",
            ...
            {thumb && typeof thumb === "object" ? (
              <>
                <img
                  ...
                  className={`${thumbClass} ${thumbSize} `}
                />
              </>
            ) : (
              <>
                {thumb && typeof thumb === "string" ? (
                  ...
                  <img src={imagePlaceholderSrc} className={thumbClass} />
                )}
              </>
            )}
          </div>
